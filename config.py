...
COMMAND_PHOTO = os.environ.get("COMMAND_PHOTO", "https://postimg.cc/7CF5hP1P")  # Replace with your photo URL
START_PIC = os.environ.get("START_PIC", "https://postimg.cc/p9TSrRVR")
...
ABOUT_TXT = os.environ.get("HELP_MESSAGE", "<i><b><blockquote>◈ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/Spicylinebun>ʂթɨƈꪗ</a>\n◈ ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/Goathunterr'>♚𝖧υηтєʀ⚰️</a>\n◈ ᴅᴀᴛᴀʙᴀsᴇ: <a href='https://www.mongodb.com/docs/'>ᴍᴏɴɢᴏ ᴅʙ</a>\n» ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href='https://t.me/Goathunterr'>♚𝖧υηтєʀ⚰️ </a></blockquote></b></i>")
...
FSUB_PIC = os.environ.get("FSUB_PIC", "https://postimg.cc/R6RSV0ps")
FSUB_LINK_EXPIRY = 300
LOG_FILE_NAME = "hunterfile.txt"
